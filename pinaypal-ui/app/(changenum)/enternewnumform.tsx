                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <Box h={"100%"} flexDirection="column" >
                        <Box flex={1} px={horizontalScale(10)} mt={verticalScale(24)} minHeight={verticalScale(136)}>
                            <Text w={"100%"}>
                                <Text lineHeight={verticalScale(48)} textAlign="left" fontSize={32} fontFamily='Poppins_600SemiBold' color="#000000" >{`Enter your new Mobile Number`}</Text>
                            </Text>
                            <Text w={"100%"} fontFamily="Poppins_400Regular">
                                <Text>We will send a verification code to your new mobile number</Text>
                            </Text>
                        </Box>
                        ...
                        <Box alignSelf="center" py={verticalScale(20)} w={"100%"} justifyContent="flex-end" mt={36}>
                            <Box>
                                <PrimaryButton label="Send OTP" onPress={() => { router.push("/(changenum)/verifynewnum"); }} />
                            </Box>

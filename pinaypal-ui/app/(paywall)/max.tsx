...
import { CloseBtn, CustomButton4, MaxBtn, PrimaryButton, SecondaryButton } from "../../components/FormElements";
...
import { PinayPalMax, SubsMax } from "../../components/AppIcon";
            ...
            <Box mt={verticalScale(24)} alignItems="center" borderWidth={"$0"}>
                ...
                <Box borderWidth={"$0"}>
                    <Text fontFamily='Poppins_600SemiBold' fontSize={19} color='#000' textAlign="center">
                        {'With PinayPal MAX, you get unlimited likes and See who likes you.'}
                    </Text>
                </Box>

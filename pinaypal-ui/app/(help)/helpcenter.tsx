        ...
        <BaseScreenWithoutBackground>
            ...
            <Box h={"100%"} alignContent="center">
                <ScrollView >
                    ...
                    <Text fontFamily='Poppins_600SemiBold' lineHeight={32} fontSize={30} py={verticalScale(10)} alignSelf='center' color='#000'>
                        How can we help you?
                    </Text>
                    <Box flex={1} px={horizontalScale(10)} py={verticalScale(20)} minHeight={verticalScale(250)} alignItems="center" justifyContent="center">
                        <Box flexDirection='row' alignContent='center'>
                            <Box flexDirection='row' alignContent='center' >
                                <Box mr={verticalScale(3)}>
                                    <CustomButton2 label="My Account" onPress={() => { router.push("/myacc"); }} />
                                </Box>
                                <Box ml={verticalScale(3)}>
                                    <CustomButton2 label="Subscription" onPress={() => { }} />
                                </Box>
                            </Box>
                        </Box>
                        <Box flexDirection='row' alignContent='center' py={verticalScale(25)} >
                            <Box mr={verticalScale(3)}>
                                <CustomButton2 label="Blocking" onPress={() => { }} />
                            </Box>
                            <Box ml={verticalScale(3)}>
                                <CustomButton2 label="Change Mobile Number" onPress={() => { }} />
                            </Box>
                        </Box>
                        <Box flexDirection='row' alignContent='center'  >
                            <Box mr={verticalScale(3)}>
                                <CustomButton2 label="Safety & Guidelines" onPress={() => { }} />
                            </Box>
                        </Box>
                        ...
                        <Box style={styles.container} alignSelf="center">
                            ...
                            <Box flexDirection='column' alignItems='center'>
                                <Text mt={10} mb={verticalScale(15)} textDecorationLine='underline' fontFamily='Poppins_600SemiBold' fontSize={21} color='#fff' onPress={() => { router.push("/(help)/myacc"); }}>
                                    Account Settings
                                </Text>
                                <Text mb={verticalScale(15)} textDecorationLine='underline' fontFamily='Poppins_600SemiBold' fontSize={21} color='#fff' onPress={() => { router.push("/"); }}>
                                    Manage Subscription
                                </Text>
                                <Text textDecorationLine='underline' fontFamily='Poppins_600SemiBold' fontSize={21} color='#fff' onPress={() => { router.push("/"); }}>
                                    Blocking
                                </Text>
                            </Box>
                        </Box>

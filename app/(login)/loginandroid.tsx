...
import { FacebookSignInBtn, GoogleSignInBtn, PhoneNumberSignInBtn, PrimaryButton, SecondaryButton, TroubleLoginBtn } from "../../components/FormElements";
        ...
        <BaseScreenWithBackground>
            ...
            <Box justifyContent="center" w={"100%"}>
                ...
                <Box mt={verticalScale(10)} alignSelf="center">
                    <Box >
                        <GoogleSignInBtn label={"Sign in with Google"} onPress={() => {
                            console.log("clicked!");

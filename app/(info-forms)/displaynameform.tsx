            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : null}>
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <Box h={"100%"} flexDirection="column" >
                        <Progress value={30} w={"100%"} mt={verticalScale(30)}>
                            <ProgressFilledTrack bg="#EF5DA8" />
                        </Progress>
                        <Box mt={verticalScale(50)} px={horizontalScale(10)} minHeight={verticalScale(150)}>
                            <Text textAlign="left" w={"100%"}>
                                <Text lineHeight={verticalScale(52)} fontSize={32} fontFamily='Poppins_600SemiBold' color="#000000" >What's your nickname? </Text>
                            </Text>
                            <Text mt={verticalScale(12)} w={"100%"} fontFamily="Poppins_400Regular">
                                <Text>This name will be utilized as your profile name.</Text>
                            </Text>
                        </Box>
                        ...
                        <Box alignSelf="center" py={verticalScale(20)} w={"100%"} justifyContent="flex-end" mt={36}>
                            <Box>
                                <PrimaryButton label="Next" onPress={() => { router.push("/birthdayform"); }} />
                            </Box>

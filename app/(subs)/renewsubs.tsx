            ...
            <Box h={"100%"} alignContent="center" flex={1}>
                <Box mt={verticalScale(30)} alignItems='center' >
                    <Box alignItems='center' mt={verticalScale(10)} >
                        <Text padding={5} textAlign='center' fontSize={24} color='#FFB9C6' fontFamily='Poppins_600SemiBold'>{'Renew your subscription'}</Text>
                    </Box >
                    <Box mt={verticalScale(60)} alignItems='center'>
                        <CancelledSub />
                    </Box>
                    <Box alignItems='center' mt={verticalScale(130)}>

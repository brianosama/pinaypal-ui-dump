...
import { PrimaryButton, CloseBtn, SecondaryButton, PlusBtn } from "../../components/FormElements";
...
import { PinayPalPlus, SubsMax, SubsPlus } from "../../components/AppIcon";
        ...
        <BaseScreenWithoutBackground>
            ...
            <Box mt={verticalScale(24)} alignItems="center" borderWidth={"$0"}>
                ...
                <Box borderWidth={"$0"}>
                    ...
                    {'With PinayPal PLUS, you get unlimited likes and hidden ads.'}
                    </Text>
                </Box>
                    ...
                    <Box alignItems="center" borderWidth={"$0"}>
                        ...
                        <Box alignItems="center" borderWidth={"$0"} mt={verticalScale(20)}>
                            ...
                            <Box mt={verticalScale(10)}>
                                <PlusBtn label="Continue" onPress={() => { }} />
                            </Box>
                        </Box>
                    </Box>
                </Box>

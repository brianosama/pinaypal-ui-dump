...
import { CancelSub, CancelledSub, FreeSub, ApplePay, NoSub, SubsMax, SubsPlus, SubsUnlimited, Wallet01 } from '../../components/AppIcon';
        ...
        <BaseScreenWithoutBackground>
            ...
            <Box h={"100%"} alignContent="center" mt={verticalScale(10)} >
                <Box style={styles.container} alignContent='flex-start' flexDirection='row'>
                    <Box alignContent='flex-start' marginLeft={horizontalScale(10)} mt={verticalScale(20)}>
                        <ApplePay />
                    </Box>
                    <Text ml={horizontalScale(45)} textAlign='center' fontFamily='Poppins_400Regular' color='#000' lineHeight={24} fontSize={22} mt={verticalScale(38)}>Apple Pay</Text>
                </Box >
                ...
                <Box alignItems='center' mt={verticalScale(10)}>
                    <BuyButton label="PROCEED" onPress={() => { router.push("/googlepay"); }} />
                </Box>
            </Box>
